...
with col_nav2:
    st.markdown(
    '<a href="/how_to_play" target="_self" '
    'style="display:block;text-align:center;padding:0.5rem;border-radius:6px;'
    'background:#262730;color:white;text-decoration:none;">'
    'how to play →</a>',
    unsafe_allow_html=True
)
